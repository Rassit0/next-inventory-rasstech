...
// Import dinámico directamente
const Table = dynamic(() => import("@heroui/react").then(mod => mod.Table), {
    ssr: false, // opcional, evita SSR si no necesitas renderizado en servidor
});
                ...
                <div className="flex justify-between gap-3 items-end">
                    <Input
                        ...
                        classNames={{
                            ...
                            inputWrapper: "border-2 text-default-foreground",
                        }}
